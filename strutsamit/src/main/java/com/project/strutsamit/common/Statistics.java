...
public class Statistics implements Serializable {
	...
	private String totalCancelAmount;
	private String totalInvalid;
	private String totalInvalidAmount;
	// netbanking Summary
	...
	public void setTotalFailedAmount(String totalFailedAmount) {
	...
	public String getTotalNewUser() {
		return totalNewUser;
	}

	public void setTotalNewUser(String totalNewUser) {
	...
	public String getTotalCancelAmount() {
		return totalCancelAmount;
	}

	public void setTotalCancelAmount(String totalCancelAmount) {
	...
	public String getTotalInvalidAmount() {
		return totalInvalidAmount;
	}

	public void setTotalInvalidAmount(String totalInvalidAmount) {
