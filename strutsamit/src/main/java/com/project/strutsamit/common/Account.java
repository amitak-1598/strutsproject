...
public class Account  implements Serializable,Comparable<Account>{
	...
	private String acquirerappId; 
	private boolean primaryStatus;
	private boolean PrimaryNetbankingStatus;
	private boolean primaryWalletStatus;
	private boolean primaryUPIStatus;
	...
	public void disableChargingDetail(String token){       
    ...
    public String getMappedString(){
    	...
    	for(Payment savedPayment:payments){
    		...
    		for(Mop mop:mops){    			
    			if(!(savedPayment.getPaymentType().getCode().equals(PaymentType.NET_BANKING.getCode()) || (savedPayment.getPaymentType().getCode().equals(PaymentType.WALLET.getCode())) 
    					|| (savedPayment.getPaymentType().getCode().equals(PaymentType.UPI.getCode())))){
	...
	public int compareTo(Account compareAccount) {
    	return compareAccount.getAcquirerappId().compareToIgnoreCase(this.acquirerappId);
	}
	...
	public String getAcquirerappId() {
		return acquirerappId;
	}

	public void setAcquirerappId(String acquirerappId) {
		this.acquirerappId = acquirerappId;
	}
	...
	public boolean isPrimaryWalletStatus() {
		return primaryWalletStatus;
	}

	public void setPrimaryWalletStatus(boolean primaryWalletStatus) {
		this.primaryWalletStatus = primaryWalletStatus;
	}

	public boolean isPrimaryUPIStatus() {
		return primaryUPIStatus;
	}

	public void setPrimaryUPIStatus(boolean primaryUPIStatus) {
		this.primaryUPIStatus = primaryUPIStatus;
	}
