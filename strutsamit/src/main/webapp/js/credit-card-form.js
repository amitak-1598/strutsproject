! function(e, t) {
    ...
    function m(e, t) {
        ...
        if (1 === t.nodeType) {
            if (vt.hasData(e) && (o = vt.access(e), a = vt.set(t, o), l = o.events)) {
                ...
                for (i in l)
                    for (n = 0, r = l[i].length; r > n; n++) et.event.add(t, i, l[i][n])
            }
    ...
    function q(e, t) {
        var n, r, i, o, a;
        for (n in e)
            if (r = et.camelCase(n), i = t[r], o = e[n], et.isArray(o) && (i = o[1], o = e[n] = o[0]), n !== r && (e[r] = o, delete e[n]), a = et.cssHooks[r], a && "expand" in a) {
    ...
    et.fn = et.prototype = {
        ...
        var e, t, n, r, i, o, a = arguments[0] || {},
            ...
            u = arguments.length,
            l = !1;
        for ("boolean" == typeof a && (l = a, a = arguments[s] || {}, s++), "object" == typeof a || et.isFunction(a) || (a = {}), s === u && (a = this, s--); u > s; s++)
            if (null != (e = arguments[s]))
                for (t in e) n = a[t], r = e[t], a !== r && (l && r && (et.isPlainObject(r) || (i = et.isArray(r))) ? (i ? (i = !1, o = n && et.isArray(n) ? n : []) : o = n && et.isPlainObject(n) ? n : {}, a[t] = et.extend(l, o, r)) : void 0 !== r && (a[t] = r));
        return a
    }, et.extend({
        ...
        function v(e, t, n, i, o, a) {
            return i && !i[R] && (i = v(i)), o && !o[R] && (o = v(o, a)), r(function(r, a, s, u) {
                var l, c, f, p = [],
                    ...
                    y = n ? o || (r ? e : h || i) ? [] : a : v;
                if (n && n(v, y, s, u), i)
                    for (l = m(y, d), i(l, [], s, u), c = l.length; c--;)(f = l[c]) && (y[d[c]] = !(v[d[c]] = f));
                if (r) {
                    if (o || e) {
                        if (o) {
        ...
        function w(e, t, n, r) {
            ...
            if (!r && 1 === l.length) {
                ...
                for (i = ht.needsContext.test(e) ? 0 : o.length; i-- && (a = o[i], !k.relative[s = a.type]);)
                    if ((u = k.find[s]) && (r = u(a.matches[0].replace(wt, Ct), xt.test(o[0].type) && c(t.parentNode) || t))) {
    ...
    et.filter = function(e, t, n) {
        ...
        find: function(e) {
            ...
            if ("string" != typeof e) return this.pushStack(et(e).filter(function() {
                for (t = 0; n > t; t++)
                    if (et.contains(i[t], this)) return !0
            }));
    ...
    var ut, lt = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/,
        ct = et.fn.init = function(e, t) {
            ...
            if ("string" == typeof e) {
                ...
                if (n[1]) {
                    if (t = t instanceof et ? t[0] : t, et.merge(this, et.parseHTML(n[1], t && t.nodeType ? t.ownerDocument || t : K, !0)), at.test(n[1]) && et.isPlainObject(t))
    ...
    et.extend({
        ...
        closest: function(e, t) {
            for (var n, r = 0, i = this.length, o = [], a = ot.test(e) || "string" != typeof e ? et(e, t || this.context) : 0; i > r; r++)
    ...
    et.Callbacks = function(e) {
        ...
        when: function(e) {
            ...
            if (a > 1)
                for (t = new Array(a), n = new Array(a), r = new Array(a); a > i; i++) o[i] && et.isFunction(o[i].promise) ? o[i].promise().done(l(i, r, o)).fail(u.reject).progress(l(i, n, t)) : --s;
    ...
    et.event = {
        ...
        add: function(e, t, n, r, i) {
            ...
            if (m)
                for (n.handler && (o = n, n = o.handler, i = o.selector), n.guid || (n.guid = et.guid++), (u = m.events) || (u = m.events = {}), (a = m.handle) || (a = m.handle = function(t) {
        ...
        remove: function(e, t, n, r, i) {
            ...
            if (m && (u = m.events)) {
                for (t = (t || "").match(dt) || [""], l = t.length; l--;)
                    if (s = jt.exec(t[l]) || [], d = g = s[1], h = (s[2] || "").split(".").sort(), d) {
                        ...
                        for (d in u) et.event.remove(e, d + t[l], n, r, !0);
    ...
    Pt.optgroup = Pt.option, Pt.tbody = Pt.tfoot = Pt.colgroup = Pt.caption = Pt.thead, Pt.th = Pt.td, et.extend({
        ...
        buildFragment: function(e, t, n, r) {
            for (var i, o, a, s, u, l, c = t.createDocumentFragment(), f = [], p = 0, d = e.length; d > p; p++)
                if (i = e[p], i || 0 === i)
                    if ("object" === et.type(i)) et.merge(f, i.nodeType ? [i] : i);
                    else if ($t.test(i)) {
            ...
            for (c.textContent = "", p = 0; i = f[p++];)
                if ((!r || -1 === et.inArray(i, r)) && (u = et.contains(i.ownerDocument, i), o = v(c.appendChild(i), "script"), u && g(o), n))
            ...
            for (var t, n, r, i, o, a, s = et.event.special, u = 0; void 0 !== (n = e[u]); u++) {
                if (et.acceptData(n) && (o = n[vt.expando], o && (t = vt.cache[o]))) {
                    if (r = Object.keys(t.events || {}), r.length)
                        for (a = 0; void 0 !== (i = r[a]); a++) s[i] ? et.event.remove(n, i) : et.removeEvent(n, i, t.handle);
        ...
        domManip: function(e, t) {
            ...
            if (l && (n = et.buildFragment(e, this[0].ownerDocument, !1, this), r = n.firstChild, 1 === n.childNodes.length && (n = r), r)) {
                ...
                if (o)
                    for (s = i[i.length - 1].ownerDocument, et.map(i, h), u = 0; o > u; u++) a = i[u], Ot.test(a.type || "") && !vt.access(a, "globalEval") && et.contains(s, a) && (a.src ? et._evalUrl && et._evalUrl(a.src) : et.globalEval(a.textContent.replace(Mt, "")))
            }
            return this
        }
    }), et.each({
    ...
    et.fn.extend({
        ...
        removeAttr: function(e, t) {
            var n, r, i = 0,
                o = t && t.match(dt);
            if (o && 1 === e.nodeType)
                for (; n = o[i++];) r = et.propFix[n] || n, et.expr.match.bool.test(n) && (e[r] = !1), e.removeAttribute(n)
        },
        attrHooks: {
            type: {
                set: function(e, t) {
    ...
    et.fn.extend({
        ...
        toggleClass: function(e, t) {
            ...
            return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : this.each(et.isFunction(e) ? function(n) {
                ...
                if ("string" === n)
                    for (var t, r = 0, i = et(this), o = e.match(dt) || []; t = o[r++];) i.hasClass(t) ? i.removeClass(t) : i.addClass(t);
            ...
            select: {
                get: function(e) {
                    for (var t, n, r = e.options, i = e.selectedIndex, o = "select-one" === e.type || 0 > i, a = o ? null : [], s = o ? i + 1 : r.length, u = 0 > i ? s : o ? i : 0; s > u; u++)
                        if (n = r[u], !(!n.selected && u !== i || (J.optDisabled ? n.disabled : null !== n.getAttribute("disabled")) || n.parentNode.disabled && et.nodeName(n.parentNode, "optgroup"))) {
...
function() {
    ...
    e = jQuery, e.payment = {}, e.payment.fn = {}, e.fn.payment = function() {
        ...
        type: "maestro",
        pattern: /^(5018|5020|5038|5612|5893|6304|6759|6220|0604|6390|6799|676[1-3])/,
        format: i,
        ...
        type: "rupay",
        pattern: /^(60|508|653[0-1]|652[1-8]|6528[6-7])/,
        format: i,
        length: [16],
        cvcLength: [3],
        luhn: !0
    ...
    $(".cardNumber").payment("formatCardNumber"), $(".cc-exp").payment("formatCardExpiry"), $(".cc-cvc").payment("formatCardCVC"), $(".cancel-link").click(function() {
        return !1
